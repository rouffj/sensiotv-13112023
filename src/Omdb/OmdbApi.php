...
final class OmdbApi
{
    ...
    private $httpClient;
    private string $composerLicence;

    public function __construct(HttpClientInterface $omdbClient, string $omdbToken, string $omdbHost, string $composerLicence)
    {
        $this->token = $omdbToken;
        $this->host = $omdbHost;
        $this->httpClient = $omdbClient;
        $this->composerLicence = $composerLicence;
    }
